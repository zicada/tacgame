...
public final class TACOntology {
	...
	public static String ask_time = "ask_time";
	public static String ask_preferences = "ask_preferences";
	public static String ask_endowments = "ask_endowments";
	public static String ask_price = "ask_time";
	public static String flight_prices = "flight_prices";
	public static String ask_flight_prices = "ask_flight_prices";
	public static String inflight_0 = "inflight_0";
	...
	public static String outflight_1 = "outflight_1";
